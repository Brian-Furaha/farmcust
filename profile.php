		...
		<div class="col-lg-10 offset-md-1" style="height:60vh">
			<div class="position-relative image-fluid w-100 mb-1" style="height:65%">
				...
				<div class="position-absolute" style="top:85%;right:3%;z-index:1">
					<button class="btn btn-dark btn-sm bg-dark" type="button" id="edit_cover"><i class="fa fa-camera"></i> Edit
						Cover Photo</button>
				</div>
					...
					<div class="col-md-12">
						<div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
							...
							<div class="card-body">
								...
								<span class="float-right text-muted counts"><span class="like-count"><?php echo number_format($liked) ?></span>
									<?php echo $liked > 1 ? "likes" : "like" ?> - <span class="comment-count"><?php echo number_format($commented) ?></span> comments</span>
							</div>
							<!-- /.card-body -->
