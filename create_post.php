...
<div class="container-fluid">
  <form action="" id="manage_post">
      ...
      <div class="ml-4 text-left" style="width:calc(80%)">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item type-item" href="javascript:void(0)" data-type="0">
              <i class="fa fa-globe-asia"></i>
              Public
            </a>
            <a class="dropdown-item type-item" href="javascript:void(0)" data-type="1">
    ...
    <div class="form-group">
      <textarea name="content" id="content" cols="30" rows="2" class="form-control" placeholder="Create post...."
    ...
    <div class="c-row" id="">
      <div id="file-display" class="column">
        <?php
				...
				?>
        <div class="imgF">
          <span class="rem badge badge-primary" onclick="rem_func($(this))" style="cursor: pointer;">
    ...
    <div class="card solid">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span>
            <label for="postF" style="cursor: pointer;">
              <a class="rounded-circle">
                <i class="fa fa-photo-video text-success"></i>
              </a>
            </label>
          </span>
        </div>
